...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
  ...
  <xsl:template match="/">
    <html>
      <head>
        <title>QGIS Server Certification Report for WMS 1.1.1</title>
  ...
  <xsl:template name="tableoc">
    <div id="navbar" class="navbar">
      ...
      <h1>QGIS Server Certification Report for WMS 1.1.1</h1>
    ...
    <p>
      ...
      <br/>
      <br/>
      Exhaustive description for Test Suite: <a href="https://opengeospatial.github.io/ets-wms11/Web_Map_Server.html">here</a>
      <br/>
      <br/>
